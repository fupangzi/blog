...
public class EmptyLayout extends LinearLayout{
     ...
     * 是否显示了子VIEW  0隐藏 1显示
     */
    public   int IS_SHOW_CHILID=0;

    public int getIS_SHOW_CHILID() {
        return IS_SHOW_CHILID;
    }
    ...
    private String mEmptyMessage = "没有数据啦";
    private String mLoadingMessage = "正在加载中...";
...
//        getChildViews();
    ...
    public void setAllButtonClickListener(OnClickListener buttonClickListener) {
        this.mErrorButtonClickListener = buttonClickListener;
        this.mEmptyButtonClickListener = buttonClickListener;
    }
    /**
...
//        bundle.putInt("mEmptyType", mEmptyType);
//        return bundle;
//    }
//    @Override
...
//            mEmptyType=bundle.getInt("mEmptyType");
//        }
